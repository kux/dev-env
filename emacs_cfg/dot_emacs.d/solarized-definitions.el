...
(defcustom solarized-colors-index nil
  "Set this to use colorset from `solarized-colors' directly"
  :type 'integer
  :group 'solarized)
...
(defvar solarized-colors
  ...
  '((base03  "#002b36" "#042028" "#1c1c1c" "#7f7f7f")
    ...
    (base3   "#fdf6e3" "#fcf4dc" "#b3b3b3" "#ffffff")
    ;; (base3   "#fdf6e3" "#fcf4dc" "#ffffd7" "#ffffff")
    (yellow  "#b58900" "#a57705" "#af8700" "#cdcd00")
    (orange  "#cb4b16" "#bd3612" "#4c1c1c" "#ff0000")
    ...
    (violet  "#6c71c4" "#5859b7" "#2c2c42" "#ff00ff")
...
(defun solarized-color-definitions (mode)
  (flet ((find-color (name)
                     (let ((index (or solarized-colors-index
                                      (if window-system
    ...
    (let ((base03    (find-color 'base03))
      ...
      (let ((back base03))
        ...
        `((;; basic
           ...
           (match ((t (:foreground ,blue :inverse-video t))))
           ...
           (mode-line-buffer-id ((t (:foreground ,base0))))
           (fringe ((t (:foreground ,base01 :background "#1e2320"))))
           (linum ((t (:foreground ,base01 :background "#1e2320"))))
           (header-line ((t (:foreground ,base1 :background "#2b2b2b"
                                         :box (:line-width 1 :color "#1e2320" :style released-button)))))
           (header-line-1 ((t (:foreground ,orange :background ,base2 :weight ,bold))))
           (mode-line
            ((t (:foreground ,base0 :background "#1e2320"
                             :box (:line-width 2 :color "#2b2b2b" :style released-button)))))
           (mode-line-inactive
            ((t (:foreground ,base01  :background "#1e2320"
                             :box (:line-width 2 :color "#1e2320")))))
           ...
           (outline-5 ((t (:foreground ,violet))))
           (outline-6 ((t (:foreground ,base0))))
           (outline-7 ((t (:foreground ,base00))))
           ...
           ;; widgets
           (widget-field
            ((t (:box (:line-width 1 :color ,base00 :background ,base03) :inherit default))))
           ...
           ;; Flymake
           (flymake-errline ((t (:background ,orange :foreground ,base2))))
           (flymake-warnline ((t (:background ,violet :foreground ,base2))))
           ;; whitespace
           ...
           ;; diredp
           (diredp-dir-priv ((t (:foreground ,blue :background ,back))))
           (diredp-dir-heading ((t (:foreground ,base1 :background "#2b2b2b"))))
           (diredp-file-name ((t (:foreground ,base0))))
           (diredp-file-suffix ((t (:foreground ,orange))))
           (diredp-ignored-file-name ((t (:foreground ,base01))))
           (diredp-symlink ((t (:foreground ,cyan))))
           ;; Anything / Anything config
           (anything-header ((t (:foreground ,base1 :background "#2b2b2b"))))
           (anything-ff-directory ((t (:foreground ,blue :background ,back))))
           (anything-candidate-number ((t (:foreground ,blue :background "#1e2320"))))
           (anything-visible-mark ((t (:foreground ,blue :inverse-video t))))
           ;; magit
           (magit-header ((t (:foreground ,base1 :background "#2b2b2b"))))
           ;; which func
           (which-func ((t (:foreground ,blue))))
           ;; sml modeline
           (sml-modeline-end-face ((t (:foreground ,base01 :background ,base03))))
           (sml-modeline-vis-face ((t (:background ,blue :foreground ,base03))))
           ;; eproject
           (eproject-mode-line-project-name-face ((t (:foreground ,yellow :bold nil))))
           ;; escape glyph
           (escape-glyph ((t (:foreground ,base02)))))
